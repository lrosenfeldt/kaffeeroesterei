...
!function (e, t) {
        ...
        value: function deprecated(e, t) {
          ...
          try {
            for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
              ...
              !1 !== _e26 && n.push.apply(n, _toConsumableArray(_e26.map(function (_ref12) {
                var e = _ref12.value;
                return {
                  value: [e]
                };
        ...
        value: function redirect(e, t) {
          ...
          try {
            for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
              ...
              "remain" in _e28 && n.push(_e28.remain), o.push.apply(o, _toConsumableArray(_e28.redirect.map(r)));
            }
          } catch (err) {
            _iterator14.e(err);
          } finally {
    ...
    var n = /*#__PURE__*/function () {
      function n(e, t) {
        ...
        var _ref15 = t || {},
            ...
            _n19 = _ref15$logger === void 0 ? console : _ref15$logger,
          ...
          try {
            var _loop5 = function _loop5() {
              ...
              var a = function a(_ref16) {
                ...
                var e = _ref19.value,
                    t = _ref19.redirectTo;
                var n = Eo.normalizeDeprecatedResult(r.deprecated(e, _this6._utils), u, !0);
                if (!1 !== n) if (!0 === n) _this6._hasDeprecationWarned(o) || _this6._utils.logger.warn(_this6._deprecatedHandler(o, t, _this6._utils));else {
    ...
    Object.defineProperty(e, "exports", {
      ...
      get: function get() {
        ...
        for (var _i23 = 0, _Object$entries2 = Object.entries(a); _i23 < _Object$entries2.length; _i23++) {
          ...
          for (var _i24 = 0, _Object$entries3 = Object.entries(_n24); _i24 < _Object$entries3.length; _i24++) {
            ...
            }, _n24[_t31] = a[_t31], e.set(_r31[0], _r31[1]);
          }
    ...
    _createClass(Qu, [{
      ...
      value: function preprocess(e, t) {
        if ("string" == typeof e && 0 !== e.length && !this._flags.includes(e)) {
          ...
          if (_n26) return t.logger.warn(["Unknown flag ".concat(Su.yellow(t.descriptor.value(e)), ","), "did you mean ".concat(Su.blue(t.descriptor.value(_n26)), "?")].join(" ")), _n26;
        }
    ...
    Object.defineProperty(e, "exports", {
      ...
      get: function get() {
        ...
        for (var _i30 = 0, _Object$keys14 = Object.keys(o); _i30 < _Object$keys14.length; _i30++) {
          ...
          for (var _i31 = 0, _Object$keys15 = Object.keys(_n28); _i31 < _Object$keys15.length; _i31++) {
            var _t41 = _Object$keys15[_i31];
            var _r38 = _n28[_t41];
            o[_t41] = {
              open: "\x1b[".concat(_r38[0], "m"),
              close: "\x1b[".concat(_r38[1], "m")
            }, _n28[_t41] = o[_t41], e.set(_r38[0], _r38[1]);
          }
    ...
    function i(e, t) {
        ...
        if (f) for (var _e66 = 0; _e66 <= f; _e66++) {
          ...
          if (s) {
            if (0 === _e66) {
              ...
              h[_n31] = [s, _e67 - s + 1];
            } else if (_e66 === f) h[_n31] = [0, l];else {
      ...
      var m = (o ? (0, n.default)(e, r) : e).split(u).slice(l, p).map(function (e, t) {
        ...
        if (i) {
          ...
          if (Array.isArray(i)) {
            var _n32 = e.slice(0, Math.max(i[0] - 1, 0)).replace(/[^\t]/g, " "),
                _o12 = i[1] || 1;

            _t46 = ["\n ", s(a.gutter, u.replace(/\d/g, " ")), _n32, s(a.marker, "^").repeat(_o12)].join(""), c && r.message && (_t46 += " " + s(a.message, r.message));
          }
  ...
  function Ui(e) {
    ...
    try {
      for (_iterator30.s(); !(_step30 = _iterator30.n()).done;) {
        ...
        if (_n33.parsers) {
          var _iterator31 = _createForOfIteratorHelper(qi(_n33.parsers)),
              _step31;

          try {
            for (_iterator31.s(); !(_step31 = _iterator31.n()).done;) {
              var _e68 = _step31.value;
              Object.defineProperty(t, _e68, Wi(_n33.parsers, _e68));
            }
          } catch (err) {
            _iterator31.e(err);
          } finally {
  ...
  function Sa(e, t) {
    for (var _n36 = e.length - 1; _n36 >= 0; _n36 -= 2) {
      var _r47 = e[_n36];
      if (_r47 && !Array.isArray(_r47) && --t < 0) return _n36;
    }
  ...
  function ts(e, t, n) {
    ...
    if (t.cursorOffset >= 0) {
      var _e84, _n37, _r50, _u11, _i44;

      if (t.cursorNode && a.cursorNodeText ? (_e84 = t.locStart(t.cursorNode), _n37 = o.slice(_e84, t.locEnd(t.cursorNode)), _r50 = t.cursorOffset - _e84, _u11 = a.cursorNodeStart, _i44 = a.cursorNodeText) : (_e84 = 0, _n37 = o, _r50 = t.cursorOffset, _u11 = 0, _i44 = a.formatted), _n37 === _i44) return {
          ...
          case "ClassPrivateMethod":
            {
              var _t55 = e.value ? e.value.async : e.async,
                  _n38 = e.value ? e.value.generator : e.generator;

              return !_t55 && "get" !== e.kind && "set" !== e.kind && !(!e.computed && !_n38);
            }
    ...
    isFunctionCompositionArgs: function isFunctionCompositionArgs(e) {
      ...
      try {
        for (_iterator37.s(); !(_step37 = _iterator37.n()).done;) {
          var _n39 = _step37.value;

          if (ec(_n39)) {
            if (t += 1, t > 1) return !0;
          } else if (sc(_n39)) {
            var _iterator38 = _createForOfIteratorHelper(_n39.arguments),
                _step38;
      ...
      var r = function (e, t) {
        ...
        var r = Ml(e, function (e) {
          ...
          if (o > -1 && "string" == typeof r[u] && r[u].startsWith("prettier-placeholder")) {
            ...
            r = r.slice(0, o).concat([_e92 + _t60]).concat(_n42);
          }
  ...
  function hp(e, t, n) {
    ...
    if ("Decorator" === e.type && "CallExpression" === r.type && "Component" === r.callee.name && 1 === r.arguments.length) {
      var _n43 = e.expression.arguments[0].properties;
      t.expression.arguments[0].properties.forEach(function (e, t) {
        var r = null;

        switch (_n43[t].key.name) {
          case "styles":
      ...
      case "Decorator":
        if ("expression" === r) {
          ...
          for (; _n44;) {
            switch (_n44.type) {
              case "MemberExpression":
                _t62 = !0, _n44 = _n44.object;
                break;

              case "CallExpression":
                if (_t62 || _e97) return !0;
                _e97 = !0, _n44 = _n44.callee;
                break;
    ...
    printObject: function printObject(e, t, n) {
      ...
      if (o.inexact) {
        ...
        if ($f(o)) {
          ...
          _n46 = Nf([_u15, _r54 || Vf(t.originalText, zf(o.comments[o.comments.length - 1])) ? Mf : kf, "..."]);
        } else _n46 = "...";

        D.push(Nf(g.concat(_n46)));
      }
  ...
  function Th(e, t, n) {
    ...
    var l = "mdx" === e.getParentNode().rootMarker,
      ...
      return e.each(function (e, t) {
        ...
        if (vh(a)) {
          ...
          if (Eh(a)) {
            var _n47 = _e100.split(Ch);

            if ("" === _n47[0]) {
              if (i.push(""), _n47.shift(), /\n/.test(_n47[0])) {
                var _e101 = u.children[t + 1];
                i.push(Nh(o, _n47[1], a, _e101));
              } else i.push(r);
            ...
            if ("" === fh(_n47) && (_n47.pop(), _s8 = _n47.pop()), 0 === _n47.length) return;
    ...
    for (var _e105 = h.length - 2; _e105 >= 0; _e105--) {
      var _t73 = "" === h[_e105] && "" === h[_e105 + 1],
          _n48 = h[_e105] === nh && "" === h[_e105 + 1] && h[_e105 + 2] === nh,
      ...
      _n48 && m || _t73 || _r56 || _u16 || _i49 ? h.splice(_e105, 2) : _o20 && h.splice(_e105 + 1, 2);
    }
    ...
    printJsxAttribute: function printJsxAttribute(e, t, n) {
      ...
      if (o.push(e.call(n, "name")), r.value) {
        ...
        if (Fh(r.value)) {
          ...
          var _n49 = hh(_e106, t.jsxSingleQuote ? "'" : '"'),
              _o21 = "'" === _n49 ? "&apos;" : "&quot;";

          _e106 = _e106.slice(1, -1).replace(new RegExp(_n49, "g"), _o21), _u17 = eh([_n49, _e106, _n49]);
  ...
  var am = {
    printPropertyKey: function printPropertyKey(e, t, n) {
      ...
      if (("Identifier" === u.type || tm(u) && nm(Zh(um(u))) && String(u.value) === Zh(um(u)) && "typescript" !== t.parser && "babel-ts" !== t.parser) && ("json" === t.parser || "consistent" === t.quoteProps && im.get(o))) {
        var _n50 = Qh(JSON.stringify("Identifier" === u.type ? u.name : u.value.toString()), t);
          ...
          case "TypeParameterInstantiation":
            {
              ...
              if ("flow" === t.parser) {
                var _e117 = LE(o),
                    ...
                    _i55 = t.originalText.indexOf("*/", _n51);
  ...
  function QC(e, t, n) {
    ...
    if ("value-root" === e.type && delete t.text, "media-query" !== e.type && "media-query-list" !== e.type && "media-feature-expression" !== e.type || delete t.value, "css-rule" === e.type && delete t.params, "selector-combinator" === e.type && (t.value = t.value.replace(/\s+/g, " ")), "media-feature" === e.type && (t.value = t.value.replace(/ /g, "")), ("value-word" === e.type && (e.isColor && e.isHex || ["initial", "inherit", "unset", "revert"].includes(t.value.replace().toLowerCase())) || "media-feature" === e.type || "selector-root-invalid" === e.type || "selector-pseudo" === e.type) && (t.value = t.value.toLowerCase()), "css-decl" === e.type && (t.prop = t.prop.toLowerCase()), "css-atrule" !== e.type && "css-import" !== e.type || (t.name = t.name.toLowerCase()), "value-number" === e.type && (t.unit = t.unit.toLowerCase()), "media-feature" !== e.type && "media-keyword" !== e.type && "media-type" !== e.type && "media-unknown" !== e.type && "media-url" !== e.type && "media-value" !== e.type && "selector-attribute" !== e.type && "selector-string" !== e.type && "selector-class" !== e.type && "selector-combinator" !== e.type && "value-string" !== e.type || !t.value || (t.value = t.value.replace(/'/g, '"').replace(/\\([^\dA-Fa-f])/g, "$1")), "selector-attribute" === e.type && (t.attribute = t.attribute.trim(), t.namespace && "string" == typeof t.namespace && (t.namespace = t.namespace.trim(), 0 === t.namespace.length && (t.namespace = !0)), t.value && (t.value = t.value.trim().replace(/^["']|["']$/g, ""), delete t.quoted)), "media-value" !== e.type && "media-type" !== e.type && "value-number" !== e.type && "selector-root-invalid" !== e.type && "selector-class" !== e.type && "selector-combinator" !== e.type && "selector-tag" !== e.type || !t.value || (t.value = t.value.replace(/([\d+.Ee-]+)([A-Za-z]*)/g, function (e, t, n) {
      ...
      var _n52 = e.value.toLowerCase();

      ["from", "to"].includes(_n52) && (t.value = _n52);
    }
  ...
  var Bb = {
    ...
    replaceQuotesInInlineComments: function replaceQuotesInInlineComments(e) {
      ...
      for (var _i59 = 0, _u30 = u; _i59 < _u30.length; _i59++) {
        ...
        e = e.slice(0, _t89) + e.slice(_t89, _n55).replace(/["'*]/g, " ") + e.slice(_n55);
      }
  ...
  function $v(e, t, n) {
    ...
    return e.each(function (e, u) {
      ...
      if (i && "css-comment" === i.type && "prettier-ignore" === i.text.trim()) {
        ...
        o.push(t.originalText.slice(_v(_n56), Rv(_n56)));
    ...
    print: function print(e, t, n) {
      ...
      switch (r.type) {
        ...
        case "css-comment":
          {
            var _e120 = r.inline || r.raws.inline,
                _n57 = t.originalText.slice(_v(r), Rv(r));

            return _e120 ? _n57.trimEnd() : _n57;
          }
        ...
        case "selector-tag":
          {
            var _t91 = e.getParentNode(),
                _n58 = _t91 && _t91.nodes.indexOf(r),
                _o30 = _n58 && _t91.nodes[_n58 - 1];
        ...
        case "selector-combinator":
          {
            if ("+" === r.value || ">" === r.value || "~" === r.value || ">>>" === r.value) {
              var _t92 = e.getParentNode(),
                  _n60 = "selector-selector" === _t92.type && _t92.nodes[0] === r ? "" : jb;

              return Lb([_n60, r.value, ov(e, r) ? "" : " "]);
            }

            var _n59 = r.value.trim().startsWith("(") ? jb : "",
        ...
        case "selector-unknown":
          {
            var _n61 = Gb(e, "css-rule");

            if (_n61 && _n61.isSCSSNesterProperty) return zv(Uv(Yb(r.value), t));

            var _o32 = e.getParentNode();

            if (_o32.raws && _o32.raws.selector) {
              var _e121 = _v(_o32),
                  _n62 = _e121 + _o32.raws.selector.length;

              return t.originalText.slice(_e121, _n62).trim();
            }
            ...
            if ("value-paren_group" === _o32.type && _u34 && "value-func" === _u34.type && "selector" === _u34.value) {
              var _e122 = _v(_o32.open) + 1,
                  _n63 = Rv(_o32.close) - 1,
                  _r90 = t.originalText.slice(_e122, _n63).trim();
        ...
        case "value-comma_group":
          {
            ...
            for (var _n64 = 0; _n64 < r.groups.length; ++_n64) {
              ...
              var _b2 = (dv(_h6) || fv(_h6)) && 0 === _n64 && ("value-number" === _m4.type || _m4.isHex) && _o33 && Lv(_o33) && !bv(_m4),
        ...
        case "value-colon":
          {
            var _t95 = e.getParentNode(),
                _n65 = _t95 && _t95.groups.indexOf(r),
                _o35 = _n65 && _t95.groups[_n65 - 1];
  ...
  function nF(e, t) {
    ...
    if (n.params.length) {
      var _n67 = e.map(t, "params");

      r.push.apply(r, _toConsumableArray(_n67));
    }

    if (n.hash && n.hash.pairs.length > 0) {
      var _n68 = e.call(t, "hash");
        ...
        case "TextNode":
          {
            ...
            if ((_n69 || _o40) && _u41 && SA(e, ["Block", "ElementNode", "Template"])) return "";
            ...
            if (e.stack.includes("attributes")) {
              ...
              var _n70 = "",
                  _o41 = "";
              return SA(e, ["ConcatStatement"]) && (wA(e, ["MustacheStatement"]) && (_n70 = " "), FA(e, ["MustacheStatement"]) && (_o41 = " ")), pA([].concat(_toConsumableArray(KA(_a14, _t98)), [r.chars.replace(/^\s+/g, _n70).replace(/\s+$/, _o41)], _toConsumableArray(KA(_s17, _t98))));
            }

            var _c15 = "",
                _l9 = "";
            0 === _s17 && FA(e, ["MustacheStatement"]) && (_l9 = " "), 0 === _a14 && wA(e, ["MustacheStatement"]) && (_c15 = " "), _n69 && (_a14 = 0, _c15 = ""), _o40 && (_s17 = 0, _l9 = "");
            var _p9 = r.chars;
  ...
  function vF(e, t, n) {
    ...
    for (var _e125 = 0; _e125 < u.length; _e125++) {
      ...
      if (_r93) {
        var _e126 = t.originalText.slice(_n71.loc.end, _r93.loc.start),
            _u42 = _e126.includes("#"),
  ...
  var RF = {
    ...
    hasGitDiffFriendlyOrderedList: function hasGitDiffFriendlyOrderedList(e, t) {
      ...
      if (0 === n && e.children.length > 2) {
        var _n72 = Number(_F(e.children[2], t.originalText).numberText);
    ...
    return e = function (e) {
      ...
      return ex(e, function (e, n, r) {
        if ("code" === e.type) {
          ...
          if (e.isIndented = _n73, _n73) for (var _e128 = 0; _e128 < r.length; _e128++) {
            var _t101 = r[_e128];
        ...
        case "word":
          {
            ...
            return _t102 !== r.value && (e.match(void 0, _n74, _o45) || e.match(void 0, _n74, function (e, t, n) {
        ...
        case "whitespace":
          {
            var _n75 = e.getParentNode(),
                _o46 = _n75.children.indexOf(r),
                _u45 = _n75.children[_o46 + 1],
        ...
        case "emphasis":
          {
            ...
            if (Rx(r.children[0])) _o47 = t.originalText[r.position.start.offset];else {
              var _t103 = e.getParentNode(),
                  _n76 = _t103.children.indexOf(r),
                  _u46 = _t103.children[_n76 - 1],
                  _i68 = _t103.children[_n76 + 1];
        ...
        case "inlineCode":
          {
            var _e131 = px(r.value, "`"),
                ...
                _n77 = _e131 && !/^\s/.test(r.value) ? " " : "";

            return mx([_t104, _n77, r.value, _n77, _t104]);
          }
        ...
        case "link":
          switch (t.originalText[r.position.start.offset]) {
            case "<":
              {
                var _e133 = "mailto:",
                    _n78 = r.url.startsWith(_e133) && t.originalText.slice(r.position.start.offset + 1, r.position.start.offset + 1 + _e133.length) !== _e133 ? r.url.slice(_e133.length) : r.url;
        ...
        case "code":
          {
            ...
            var _e134 = t.__inJsTemplate ? "~" : "`",
                _n79 = _e134.repeat(Math.max(3, dx(r.value, _e134) + 1));

            return mx([_n79, r.lang || "", r.meta ? " " + r.meta : "", Cx, mx(Bx(Ox(r, t.originalText), Cx)), Cx, _n79]);
          }

        case "html":
          {
            var _t105 = e.getParentNode(),
                _n80 = "root" === _t105.type && lx(_t105.children) === r ? r.value.trimEnd() : r.value,
                _o48 = /^<!--[\S\s]*-->$/.test(_n80);

            return mx(Bx(_n80, _o48 ? Cx : Ex(yx)));
          }
  ...
  var $S = {
      ...
      var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (e) {
        ...
        try {
          for (_iterator42.s(); !(_step42 = _iterator42.n()).done;) {
            var _n82 = _step42.value;
            if (0 === _n82.length) continue;
            if (!yS.has(_n82[0])) return 0;
            var _e137 = CS(_n82).length;
            _n82.length !== _e137 && _e137 < t && (t = _e137);
          }
        } catch (err) {
          _iterator42.e(err);
        } finally {
    ...
    var n = /*#__PURE__*/function () {
      function n(e, t, _n83) {
        ...
        this.filePath = e, this.name = t, this.members = _n83;
      }
    ...
    t.utf8Encode = function (e) {
      ...
      for (var _n84 = 0; _n84 < e.length; _n84++) {
        var _r98 = e.charCodeAt(_n84);

        if (_r98 >= 55296 && _r98 <= 56319 && e.length > _n84 + 1) {
          var _t108 = e.charCodeAt(_n84 + 1);

          _t108 >= 56320 && _t108 <= 57343 && (_n84++, _r98 = (_r98 - 55296 << 10) + _t108 - 56320 + 65536);
        }
    ...
    var a = /*#__PURE__*/function () {
      _createClass(a, null, [{
        key: "create",
        value: function create(_ref46) {
          var e = _ref46.isHost,
              t = _ref46.type,
              r = _ref46.isComponent,
              o = _ref46.selector,
              u = _ref46.exportAs,
              i = _ref46.changeDetection,
              s = _ref46.inputs,
              c = _ref46.outputs,
              l = _ref46.host,
              p = _ref46.providers,
              d = _ref46.viewProviders,
              f = _ref46.queries,
              h = _ref46.guards,
              m = _ref46.viewQueries,
              g = _ref46.entryComponents,
              D = _ref46.template,
              y = _ref46.componentViewType,
              E = _ref46.rendererType,
              C = _ref46.componentFactory;
          var b = {},
              v = {},
              A = {};
      ...
      function a(_ref47) {
        var e = _ref47.isHost,
            t = _ref47.type,
            n = _ref47.isComponent,
            r = _ref47.selector,
            o = _ref47.exportAs,
            u = _ref47.changeDetection,
            i = _ref47.inputs,
            _a15 = _ref47.outputs,
            c = _ref47.hostListeners,
            l = _ref47.hostProperties,
            p = _ref47.hostAttributes,
            d = _ref47.providers,
            f = _ref47.viewProviders,
            h = _ref47.queries,
            m = _ref47.guards,
            g = _ref47.viewQueries,
            D = _ref47.entryComponents,
            y = _ref47.template,
            E = _ref47.componentViewType,
            C = _ref47.rendererType,
            b = _ref47.componentFactory;
    ...
    var n = /*#__PURE__*/function () {
      function n(e, t, _n85, r) {
        _classCallCheck(this, n);

        this.file = e, this.offset = t, this.line = _n85, this.col = r;
      }
      ...
      _createClass(n, [{
        ...
        value: function moveBy(e) {
          ...
          for (; o < r && e > 0;) {
            var _n86 = t.charCodeAt(o);

            o++, e--, _n86 == qS.$LF ? (u++, i = 0) : i++;
          }
        ...
        value: function getContext(e, t) {
          ...
          if (null != r) {
            ...
            for (_u49 = 0, _i70 = 0; _u49 < e && _o52 < n.length - 1 && (_o52++, _u49++, "\n" != n[_o52] || ++_i70 != t);) {
              ;
            }

            return {
              before: n.substring(r, this.offset),
              after: n.substring(this.offset, _o52 + 1)
            };
          }
  ...
  var HS = zS.ParseSourceSpan,
    ...
    return e.map(function (e) {
      if ("element" === e.type && e.tagDefinition.ignoreFirstLf && 0 !== e.children.length && "text" === e.children[0].type && "\n" === e.children[0].value[0]) {
        var _e$children2 = _toArray(e.children),
            ...
            _n87 = _e$children2.slice(1);

        return e.clone({
          children: 1 === _t109.value.length ? _n87 : [_t109.clone({
            value: _t109.value.slice(1)
          })].concat(_toConsumableArray(_n87))
        });
      }
      ...
      if (e.children) {
        ...
        if (_n88.some(Boolean)) {
          ...
          for (var _r99 = 0; _r99 < e.children.length; _r99++) {
            ...
            if (!_n88[_r99 + 1]) if (_n88[_r99]) {
              var _e139 = _o53.prev,
                  _n89 = _o53.firstChild,
                  _r100 = new HS(_e139.sourceSpan.start, _n89.sourceSpan.end),
    ...
    return e.map(function (e) {
      ...
      try {
        for (_iterator43.s(); !(_step43 = _iterator43.n()).done;) {
          ...
          for (var _n90 = 0; _n90 < _u52.length; _n90++, _e140 = _o55) {
            var _r103 = _u52[_n90];
            _n90 % 2 != 0 ? (_o55 = _e140.moveBy(_r103.length + 4), t.push({
              type: "interpolation",
    ...
    return e.map(function (e) {
      if (e.children) {
        var _n91 = e.children.map(t);

        if (_n91.some(Boolean)) {
          var _t112 = [];
          ...
          for (var _r104 = 0; _r104 < e.children.length; _r104++) {
            ...
            if (_n91[_r104]) {
              ...
              _t112.push(_n92.clone({
                value: _n92.value + "<".concat(_o56.rawName, ">") + _o56.firstChild.value + "</".concat(_o56.rawName, ">") + _u53.value,
                sourceSpan: new HS(_n92.sourceSpan.start, _u53.sourceSpan.end),
        ...
        case "text":
          if ("interpolation" === r.parent.type) {
            var _e141 = /\n[^\S\n]*?$/,
                ...
                _n94 = _t114 ? r.value.replace(_e141, "") : r.value;

            return lT([lT(Cw(_n94, kw)), _t114 ? Sw : ""]);
          }
  ...
  var YT = {
    ...
    isLastDescendantNode: function isLastDescendantNode(e) {
      ...
      for (var _n96 = 1; _n96 < t; _n96++) {
        var _t121 = e.stack[_n96],
            _r107 = e.stack[_n96 - 1];
      ...
      case "quoteSingle":
        {
          ...
          if ("quoteSingle" === e.type && _o60.includes("\\") || "quoteDouble" === e.type && /\\[^"]/.test(_o60)) {
            var _u62 = "quoteDouble" === e.type ? _n97 : _t124;

            return eB([_u62, HB(e.type, _o60, r), _u62]);
          }

          if (_o60.includes(_n97)) return eB([_t124, HB(e.type, "quoteDouble" === e.type ? _o60.replace(/\\"/g, _n97).replace(/'/g, _t124.repeat(2)) : _o60, r), _t124]);
          if (_o60.includes(_t124)) return eB([_n97, HB(e.type, "quoteSingle" === e.type ? _o60.replace(/''/g, _t124) : _o60, r), _n97]);

          var _u61 = r.singleQuote ? _t124 : _n97;
...
},{}],"js/NavbarColorer.js":[function(require,module,exports) {
"use strict";
...
var NavbarColorer = /*#__PURE__*/function () {
  function NavbarColorer() {
    _classCallCheck(this, NavbarColorer);
    ...
    this.registerCartAction();
  }

  _createClass(NavbarColorer, [{
    key: "isCartEmpty",
    value: function isCartEmpty() {
      var cartProducts = (0, _utils.loadCartFromStorage)();
      return !cartProducts || cartProducts.length === 0;
    }
  }, {
    key: "addFilledCartIcon",
    value: function addFilledCartIcon() {
      this.cartIconElements.forEach(function (element) {
        element.classList.add("cart-icon--filled");
      });
    }
  }, {
    key: "removeFilledCartIcon",
    value: function removeFilledCartIcon() {
      this.cartIconElements.forEach(function (element) {
    ...
    key: "registerIntersection",
    value: function registerIntersection() {
    ...
    key: "registerCartAction",
    value: function registerCartAction() {
      var _this2 = this;

      window.addEventListener("storage", function () {
        console.log("storage");

        if (_this2.isCartEmpty()) {
          _this2.removeFilledCartIcon();
        } else {
          _this2.addFilledCartIcon();
        }
      });
    }
  }]);

  return NavbarColorer;
}();

var _default = NavbarColorer;
exports.default = _default;
},{"./utils.js":"js/utils.js"}],"js/burgeMenu.js":[function(require,module,exports) {
"use strict";
...
function enableBurgerMenu() {
  burgerMenu.addEventListener("click", function () {
    ...
    if (!burgerMenu.classList.contains("burger-menu--light") && !burgerMenu.classList.contains("burger-menu--clicked")) {
      burgerMenu.classList.add("burger-menu--light");
    } else if (burgerMenu.classList.contains("burger-menu--clicked") && !navbar.classList.contains("navbar--light")) {
...
var _NavbarColorer = _interopRequireDefault(require("./NavbarColorer"));

var _burgeMenu = _interopRequireDefault(require("./burgeMenu"));
...
window.addEventListener("load", function () {
  (0, _burgeMenu.default)();
  var foo = new _NavbarColorer.default();
});
},{"prettier":"../node_modules/prettier/standalone.js","./NavbarColorer":"js/NavbarColorer.js","./burgeMenu":"js/burgeMenu.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
